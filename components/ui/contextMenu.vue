...
function toggleSection(section) {
  ...
  if (section === 'resource') isResourceCollapsed.value = !isResourceCollapsed.value
  if (section === 'embedded') isEmbeddedCollapsed.value = !isEmbeddedCollapsed.value
}
...
<template>
  <div id="contextWrapper" @wheel.stop>
    ...
    <div v-if="!isTextCollapsed" class="context-section">
      <p class="context-add-text" @click="$emit('text-click')">Text</p>
